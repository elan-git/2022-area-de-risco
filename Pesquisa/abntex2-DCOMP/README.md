...
## Informações Gerais
Repositório original de Kalil Bispo: https://git.dcomp.ufs.br/kalilbispo/abntex2-DCOMP-UFS

Atualizações devem ser verificadas a partir do repositório original
